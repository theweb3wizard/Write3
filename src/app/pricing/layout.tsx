...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Start for free, no credit card required. Upgrade to Creator ($29/mo), Pro ($69/mo), or Agency ($199/mo). Unlimited content generation, voice training profiles, and team access.",
  openGraph: {
